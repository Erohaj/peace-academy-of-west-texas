...
- Full legal name (typed): `_______________`
- Email: `_______________`
- If signing for a minor — minor's name and your relationship: `_______________`
- Choice recorded in section 4: `_______________`
