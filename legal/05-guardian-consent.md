...
also withdraws the Minor from future activities.

---

**Signature block**

- Minor's full legal name: `_______________`
- Minor's date of birth: `_______________`
- Parent/guardian's full legal name (typed): `_______________`
- Relationship to the Minor: `_______________`
- Parent/guardian's email: `_______________`
- Parent/guardian's phone: `_______________`
- Second emergency contact (name and phone): `_______________`
- Date signed: *recorded automatically*

By typing my name and submitting this form, I intend it as my electronic
signature under the federal ESIGN Act and the Texas Uniform Electronic
Transactions Act. I confirm that I am the Minor's parent or legal guardian.
