...
export const CertificateView: React.FC<Props> = ({ certificate }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      {isRevoked && (
        <div className="flex items-start gap-2 bg-[#A64D32]/10 border border-[#A64D32]/30 rounded-2xl px-4 py-3 text-xs text-[#A64D32] print:hidden">
      ...
      >
        ...
        <div className="text-center space-y-3">
          ...
          <p className="text-3xl font-serif font-bold text-[#2A2A2A]">
      ...
      {/* Printing only the card: everything else on the page (nav, sidebar,
          this print button) is chrome that means nothing on a printed page,
          and the volunteer portal's dark-mode-aware colours would otherwise
          print as-is rather than as clean black-on-white. */}
      <style>{`
        @media print {
