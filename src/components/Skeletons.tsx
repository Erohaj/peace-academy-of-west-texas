...
export const EventCardSkeleton: React.FC = () => {
  return (
    <div className="bg-[#F4F1ED] rounded-[24px] overflow-hidden border border-[#E5E0D8] shadow-sm flex flex-col h-full animate-pulse">
      {/* Image Skeleton */}
      <div className="relative h-56 bg-[#E5E0D8] overflow-hidden">
      ...
      <div className="p-6 flex-1 flex flex-col justify-between space-y-4">
        <div className="space-y-3">
          {/* Title Lines */}
          <div className="h-7 bg-[#E5E0D8] rounded-md w-3/4" />
          <div className="h-7 bg-[#E5E0D8] rounded-md w-1/2" />

          {/* Description Lines */}
          <div className="space-y-2 pt-2">
            <div className="h-3.5 bg-[#E5E0D8] rounded-md w-full" />
            <div className="h-3.5 bg-[#E5E0D8] rounded-md w-5/6" />
            <div className="h-3.5 bg-[#E5E0D8] rounded-md w-4/6" />
          </div>
...
export const CalendarSkeleton: React.FC = () => {
  return (
    <div className="space-y-8 animate-pulse">
      ...
      <div className="bg-[#F4F1ED] rounded-3xl p-6 border border-[#E5E0D8] space-y-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            <div className="w-16 h-8 bg-[#E5E0D8] rounded-full" />
            <div className="w-20 h-8 bg-[#E5E0D8] rounded-full" />
          </div>
        </div>
      ...
      {/* Grid Skeleton */}
      <div className="bg-[#FDFBF7] rounded-3xl border border-[#E5E0D8] overflow-hidden">
        {/* Weekday headers */}
        <div className="grid grid-cols-7 bg-[#F4F1ED] border-b border-[#E5E0D8] py-3">
          {Array.from({ length: 7 }).map((_, i) => (
            <div key={i} className="flex justify-center">
              <div className="h-3 w-8 bg-[#E5E0D8] rounded-md" />
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-7 auto-rows-fr divide-x divide-y divide-[#E5E0D8]/60 bg-white">
          {Array.from({ length: 35 }).map((_, i) => (
            <div key={i} className="min-h-[90px] sm:min-h-[110px] p-2 flex flex-col justify-between">
              <div className="w-5 h-5 bg-[#E5E0D8] rounded-full" />
              {i % 4 === 0 && (
      ...
      <div className="bg-[#F4F1ED] rounded-3xl p-6 sm:p-8 border border-[#E5E0D8] space-y-6">
        <div className="h-6 w-48 bg-[#E5E0D8] rounded-md" />
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="h-64 bg-[#E5E0D8] rounded-2xl" />
          <div className="h-64 bg-[#E5E0D8] rounded-2xl" />
        </div>
      </div>
    </div>
