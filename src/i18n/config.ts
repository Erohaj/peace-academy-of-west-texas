  ...
  en: {
    translation: {
      ...
      rsvpModal: {
        ...
        errorOverTitle: "This event has already taken place",
        errorOverText: "Registration for it is closed. Have a look at what is coming up next — we would love to see you there.",
      ...
      volunteer: {
        ...
        profileNamePlaceholder: "Maria Gonzalez",
        profilePhone: "Phone (optional)",
        profileEmail: "Sign-in email",
  ...
  es: {
    translation: {
      ...
      rsvpModal: {
        ...
        errorOverTitle: "Este evento ya se realizó",
        errorOverText: "El registro está cerrado. Mira los próximos eventos — nos encantaría verte allí.",
      ...
      volunteer: {
        ...
        profileNamePlaceholder: "María González",
        profilePhone: "Teléfono (opcional)",
        profileEmail: "Correo de acceso",
        profileSave: "Guardar datos",
        profileSaving: "Guardando...",
        profileSaved: "Guardado.",
        profileError: "No pudimos guardar tus datos. Inténtalo de nuevo.",
